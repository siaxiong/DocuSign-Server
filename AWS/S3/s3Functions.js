...
const {getAllUsers} = require("../../Database/db-functions");
/**
...
const getFile = async (fileName) => {
    ...
    const response = await s3Client.send(cmd);
    console.log("🚀 ----------------------------------------------------------------------🚀");
    console.log("🚀 -> file: s3Functions.js -> line 91 -> getFile -> response", response.body);
    console.log("🚀 ----------------------------------------------------------------------🚀");
...
const getAllFiles = async (email) => {
    ...
    try {
        const response = await s3Client.send(cmd);
        console.log("🚀 ---------------------------------------------------------------------------🚀");
        console.log("🚀 -> file: s3Functions.js -> line 108 -> getAllFiles -> response", response);
        console.log("🚀 ---------------------------------------------------------------------------🚀");
...
module.exports = {getUploadURL, deleteFile, getFile, getAllFiles, getAllEmails};
